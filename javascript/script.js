...
function updateTimer() {
  const targetDate = new Date("february 22, 2026 14:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '543813598050'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '543885828304'; // Número para el primer botón
